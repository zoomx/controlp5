...
/**
 * ControlFont is a container for a PFont that can be used for customizing the
...
public class ControlFont {
	...
	/**
	 * create a controlFont and pass a reference to a PFont. fontsize needs to be
	 * defined as second parameter.
	 * 
	 * @param theFont
	 * @param theFontSize
	 */
