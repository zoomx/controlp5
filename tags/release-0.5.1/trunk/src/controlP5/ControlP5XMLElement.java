...
public class ControlP5XMLElement {
	 ...
	 * <li>The field can be empty.
	 * <li>The field is never <code>null</code>.
	 * <li>The elements are instances of <code>XMLElement</code> or a subclass of
	 ...
	 *      XMLElement(Hashtable, boolean)
	 */
	public ControlP5XMLElement(Hashtable entities) {
	 ...
	 *      XMLElement(Hashtable, boolean)
	 */
	public ControlP5XMLElement(boolean skipLeadingWhitespace) {
	 ...
	 *      XMLElement(Hashtable)
	 */
	public ControlP5XMLElement(Hashtable entities, boolean skipLeadingWhitespace) {
	 ...
	 *      XMLElement(Hashtable, boolean)
	 */
	public ControlP5XMLElement(Hashtable entities, boolean skipLeadingWhitespace, boolean ignoreCase) {
	 ...
	 *        fillBasicConversionTable == false</code> then <code>entities</code>
	 *        contains at least the following entries: <code>amp</code>, <code>lt
	 *        </code>, <code>gt</code>, <code>apos</code> and <code>quot</code>
	 *        </ul>
	 *        </dd>
	 *        </dl>
	 * 
	 ...
	 *        enumeration <li>enumeratePropertyNames() => empty enumeration <li>
	 *        getChildren() => empty vector <li>getContent() => "" <li>getLineNr()
	 *        => 0 <li>getName() => null
	 *        </ul>
	 *        </dd>
	 *        </dl>
	 ...
	 * then <code>getAttribute("attr", mapping, defaultKey, false)</code> returns
	 * <code>"1"</code>.
	 * 
	 * @param name
	 *        The name of the attribute.
	 ...
	 *        <dt><b>Preconditions:</b></dt><dd>
	 *        <ul>
	 *        <li><code>name != null</code> <li><code>name</code> is a valid XML
	 *        identifier <li><code>valueSet</code> != null <li>the keys of <code>
	 ...
	 *        <li><code>name != null</code> <li><code>name</code> is a valid XML
	 *        identifier <li><code>valueSet</code> != null <li>the keys of <code>
	 *        valueSet</code> are strings <li>the values of <code>valueSet</code>
	 *        are strings
	 *        </ul>
	 *        </dd>
	 *        </dl>
	 ...
	 * is returned.
	 * <P>
	 * As an example, if valueSet contains the mapping <code>"one" => 1</code> and
	 * the element contains the attribute <code>attr="one"</code>, then
	 ...
	 *        identifier <li><code>valueSet</code> != null <li>the keys of <code>
	 *        valueSet</code> are strings <li>the values of <code>valueSet</code>
	 *        are Integer objects <li><code>defaultKey</code> is either <code>null
	 *        </code>, a key in <code>valueSet</code> or an integer.
	 *        </ul>
	 *        </dd>
	 *        </dl>
	 *        <dl>
	 ...
	 * then <code>getDoubleAttribute("attr", mapping, defaultKey, false)</code>
	 ...
	 *        <ul>
	 *        <li><code>name != null</code> <li><code>name</code> is a valid XML
	 *        identifier <li><code>valueSet != null</code> <li>the keys of <code>
	 *        valueSet</code> are strings <li>the values of <code>valueSet</code>
	 *        are Double objects <li><code>defaultKey</code> is either <code>null
	 *        </code>, a key in <code>valueSet</code> or a double.
	 *        </ul>
	 *        </dd>
	 *        </dl>
	 *        <dl>
	 ...
	 */
	public void parseFromReader(Reader reader) throws IOException, ControlP5XMLParseException {
	 ...
	 *         If an error occured while parsing the read data.
	 */
	public void parseFromReader(Reader reader, int startingLineNr) throws IOException, ControlP5XMLParseException {
	 ...
	 */
	public void parseString(String string) throws ControlP5XMLParseException {
		try {
	 ...
	 *         If an error occured while parsing the string.
	 */
	public void parseString(String string, int offset) throws ControlP5XMLParseException {
	 ...
	 *         If an error occured while parsing the string.
	 */
	public void parseString(String string, int offset, int end) throws ControlP5XMLParseException {
	 ...
	 *         If an error occured while parsing the string.
	 */
	public void parseString(String string, int offset, int end, int startingLineNr) throws ControlP5XMLParseException {
	 ...
	 *         If an error occured while parsing the string.
	 */
	public void parseCharArray(char[] input, int offset, int end) throws ControlP5XMLParseException {
	 ...
	 *         If an error occured while parsing the string.
	 */
	public void parseCharArray(char[] input, int offset, int end, int startingLineNr) throws ControlP5XMLParseException {
		try {
	 ...
	 * @see nanoxml.XMLElement#getChildren()
	 */
	public void removeChild(ControlP5XMLElement child) {
	 ...
	 */
	protected ControlP5XMLElement createAnotherElement() {
		return new ControlP5XMLElement(this.entities, this.ignoreWhitespace, false, this.ignoreCase);
	}
	...
	public void write(Writer writer) throws IOException {
		...
		if ((this.contents != null) && (this.contents.length() > 0)) {
			...
			while (myEnum.hasMoreElements()) {
				ControlP5XMLElement child = (ControlP5XMLElement) myEnum.nextElement();
				child.write(writer);
			}
			writer.write('<');
			writer.write('/');
	 ...
	 * The scanned string without delimiters is appended to <code>string</code>.
	 * 
	 * </dl>
	 * <dl>
	 * <dt><b>Preconditions:</b></dt>
	 ...
	 *        </dl>
	 */
	protected void scanElement(ControlP5XMLElement elt) throws IOException {
		...
		if (buf.length() == 0) {
			while (ch != '/') {
				if (ch == '!') {
					...
					this.unreadChar(ch);
					ControlP5XMLElement child = this.createAnotherElement();
	 ...
	 *        </dl>
	 */
	protected ControlP5XMLParseException invalidValueSet(String name) {
		String msg = "Invalid value set (entity name = \"" + name + "\")";
		return new ControlP5XMLParseException(this.getName(), this.parserLineNr, msg);
	}
	 ...
	 *        </dl>
	 */
	protected ControlP5XMLParseException invalidValue(String name, String value) {
	 ...
	 * reached.
	 */
	protected ControlP5XMLParseException unexpectedEndOfData() {
	 ...
	 *        </dl>
	 */
	protected ControlP5XMLParseException syntaxError(String context) {
	 ...
	 *        </dl>
	 */
	protected ControlP5XMLParseException expectedInput(String charSet) {
	 ...
	 *        </dl>
	 */
	protected ControlP5XMLParseException unknownEntity(String name) {
		String msg = "Unknown or invalid entity: &" + name + ";";
		return new ControlP5XMLParseException(this.getName(), this.parserLineNr, msg);
	}

	// public static void checkColor(
	// ControllerProperties theProperties1,
	// ControllerProperties theProperties2,
	// ControlP5XMLElement theElement
	// ) {
	// if(theProperties1!=null && theProperties2!=null) {
	// if (theProperties1.colorBackground != theProperties2.colorBackground) {
	// theElement.setAttribute(
	// "colorBackground",
	// ControlP5IOHandler.intToString(theProperties2.colorBackground));
	// theProperties1.colorBackground = theProperties2.colorBackground;
	// }
	//
	// if (theProperties1.colorForeground != theProperties2.colorForeground) {
	// theElement.setAttribute(
	// "colorForeground",
	// ControlP5IOHandler.intToString(theProperties2.colorForeground));
	// theProperties1.colorForeground = theProperties2.colorForeground;
	// }
	// if (theProperties1.colorActive != theProperties2.colorActive) {
	// theElement.setAttribute(
	// "colorActive",
	// ControlP5IOHandler.intToString(theProperties2.colorActive));
	// theProperties1.colorActive = theProperties2.colorActive;
	// }
	// if (theProperties1.colorLabel != theProperties2.colorLabel) {
	// theElement.setAttribute(
	// "colorLabel",
	// ControlP5IOHandler.intToString(theProperties2.colorLabel));
	// theProperties1.colorActive = theProperties2.colorLabel;
	// }
	// if (theProperties1.colorValue != theProperties2.colorValue) {
	// theElement.setAttribute(
	// "colorValue",
	// ControlP5IOHandler.intToString(theProperties2.colorValue));
	// theProperties1.colorValue = theProperties2.colorValue;
	// }
	// }
	// }
